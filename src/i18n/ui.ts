...
export const ui = {
  en: {
    ...
    'projects.next.1': 'Artefact parsers for what NootExtract collects',
    'projects.next.2': 'More systems work in Rust',
  ...
  fr: {
    ...
    'projects.next.1': 'Des analyseurs pour les artefacts que NootExtract collecte',
    'projects.next.2': 'Davantage de travail système en Rust',
